...
const AddHotel = () => {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4 font-sans animate-in fade-in duration-700">
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 sm:p-12 max-w-md text-center border border-gray-200 dark:border-gray-800">
          <div className="w-20 h-20 bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm">
            <svg
              className="w-10 h-10"
              fill="none"
              stroke="currentColor"
          ...
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
            Your property application is currently under review. If approved,
            you will receive an email notification shortly.
          </p>
          <button
            onClick={() => navigate("/admin-dashboard/properties")}
            className="w-full px-6 py-3.5 bg-gray-900 hover:bg-black dark:bg-white dark:hover:bg-gray-100 text-white dark:text-gray-900 text-[12px] font-bold uppercase tracking-wide rounded-xl shadow-md transition-all active:scale-95"
          >
            Return to Dashboard
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 bg-gray-50 dark:bg-gray-950 font-sans">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-100 dark:border-gray-800 pb-6">
          <div>
            ...
            <p className="text-[11px] font-bold uppercase tracking-widest text-gray-400 mt-2">
              Submit a new hotel or property for approval
            </p>
          </div>
          <button
            onClick={() => navigate(-1)}
            className="w-10 h-10 flex items-center justify-center rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer shadow-sm"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <section>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe your property, its uniqueness, and surroundings..."
